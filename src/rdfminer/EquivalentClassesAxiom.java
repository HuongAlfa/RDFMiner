...
public class EquivalentClassesAxiom extends Axiom
{
	...
	/**
	 * An array of complements of the class expressions which are declared to be mutually equivalent.
	 */
	protected Expression[] equivalentClassComplement;

	/**
	 * Create a new <code>EquivalentClasses</code> axiom from the given list of concept expressions.
	 * 
	 *
	 */
